...
import { Search, Plus, UserPen, Ban, Save, X, Upload } from 'lucide-react';
...
const GestaoUsuarios = () => {
  ...
  const availableCargos = ['Gerente', 'Analista', 'Coordenador', 'Assistente', 'Diretor'];
          ...
          <DialogContent className="sm:max-w-md bg-white">
            ...
            {selectedUser && (
              <div className="space-y-4">
                ...
                <div>
                  <label className="text-sm font-medium">Setor</label>
                  <Select value={selectedUser.setor} onValueChange={(value) => setSelectedUser({...selectedUser, setor: value})}>
                    <SelectTrigger className="border-gray-300">
                      <SelectValue placeholder="Selecionar setor" />
                    </SelectTrigger>
                    <SelectContent className="bg-white">
                ...
                <div>
                  <label className="text-sm font-medium">Cargo</label>
                  <Select value={selectedUser.cargo} onValueChange={(value) => setSelectedUser({...selectedUser, cargo: value})}>
                    <SelectTrigger className="border-gray-300">
                      <SelectValue placeholder="Selecionar cargo" />
                    </SelectTrigger>
                    <SelectContent className="bg-white">
